    ...
    <div class="flex flex-1 justify-end items-center text-right px-4">
        ...
        >
            ...
            <button
                ...
                class="absolute pin-t pin-r h-10 font-light text-3xl text-blue hover:text-primary-4 focus:outline-none -mt-px pr-7 md:pr-3"
                @click="reset"
            >&times;</button>

            <transition name="fade">
                <div v-if="query" class="absolute pin-l pin-r md:pin-none w-full lg:w-3/4 text-left mb-4 md:mt-10">
                    <div class="flex flex-col bg-white border border-b-0 border-t-0 border-primary-7 rounded-b-lg shadow-lg mx-4 md:mx-0">
                        <a
                            v-for="(result, index) in results"
                            class="bg-white hover:bg-primary-10 border-b border-primary-7 text-xl cursor-pointer p-4"
                        ...
                        <div
                            v-if="! results.length"
                            class="bg-white w-full hover:bg-primary-10 border-b border-primary-7 rounded-b-lg shadow cursor-pointer p-4"
                        >
