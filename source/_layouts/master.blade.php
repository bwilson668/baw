...
<html lang="en">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Damion|Nunito+Sans&display=swap" rel="stylesheet">
    ...
    <body class="flex flex-col justify-between min-h-screen bg-neutral-10 text-neutral-1 leading-normal font-sans">
        ...
        <main id="body" role="main" class="flex-auto w-full container max-w-xl mx-auto py-16 px-6">
            @yield('body')
        </main>
        ...
        <footer class="bg-white text-center text-sm mt-12 py-4" role="contentinfo">
            <ul class="flex flex-col md:flex-row justify-center list-reset">
                <li class="md:mr-2">
                    &copy; <a href="https://benjaminandrewwilson.com" title="Tighten website">Tighten</a> {{ date('Y') }}.
                </li>
